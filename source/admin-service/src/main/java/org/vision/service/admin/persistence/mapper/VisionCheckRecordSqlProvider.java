...
public class VisionCheckRecordSqlProvider {

    public String insertSelective(VisionCheckRecord record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("vision_check_record");
    ...
    public String updateByPrimaryKeySelective(VisionCheckRecord record) {
        SQL sql = new SQL();
        sql.UPDATE("vision_check_record");
